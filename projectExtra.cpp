...
* Summary: 
*       SUDOKU
*           This program will create a simple Sudoku game that a user
*           can interact with. A simple menu and board will be output
*           to the console. This is the complete game.   
*
*    Estimated:  1.0 hrs   
*    Actual:     3.0 hrs
*      I had to look up how to properly use the color codes. I couldnt
*       figure out how to change the output of an array to a specific
*       color.
*       I couldn't figure out how to switch cases in my input. A2 or 2A.
************************************************************************/
